...
function draw() {
    ...
    mat4.lookAt(viewMatrix, vec3.fromValues(5, 0.2, 7), vec3.fromValues(0, 0, 0), vec3.fromValues(0, 1, 0));
    mat4.multiply(viewProjMatrix, projMatrix, viewMatrix);

    mat4.fromXRotation(rotateXMatrix, time * 0.51136);
    mat4.fromYRotation(rotateYMatrix, time * 0.42235);
